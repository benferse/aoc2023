...
impl<'a> Map<'a> {
    pub fn parse(input: &'a str) -> Self {
        ...
        // First line is the set of instructions
        // The rest are node mappings
...
pub fn parse(input: &str) -> (&str, HashMap<&str, (&str, &str)>) {
...
mod answers {
    ...
    pub fn problem2(input: &str) -> u64 {
        ...
        map.part2_nodes()
            .map(|&start| {
                map.count_steps_until(start, |x| x.ends_with('Z'))
            })
